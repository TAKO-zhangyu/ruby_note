...
# 対多のとき（この場合、ユーザーがツイートを投稿するだけのアプリの時）、1人のユーザーが3ツイート投稿したとしたらUser_id=1 が Message_id=1, id=2, id=3を投稿したという内容になる。
# 1人のユーザーから見れば自分の投稿は複数あるが、ツイートから見れば投稿主は一人のみ。なので、それぞれの関係は１つしかなく、言い換えるとMessage_id=1 の中にはUser_id=1の情報しかなく、1つのカラムにそれ以外の情報を入れることはない。なので、1対多のときは中間テーブルを作らなくてもいい。
